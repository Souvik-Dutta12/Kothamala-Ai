            ...
            <section className='left relative flex flex-col h-full min-w-96 bg-slate-300'>
                ...
                <div className="conversation-area flex-grow flex flex-col">
                    ...
                    className="message-box p-1 flex-grow flex flex-col gap-1">
                        ...
                        <div className="outgoing max-w-56 ml-auto message flex flex-col p-2 bg-slate-50 w-fit rounded-md">
                            <small className='opacity-65 text-xs'>example@gmail.com</small>
                            <p className='text-sm'>Lorem ipsum dolor sit amet.
                            </p>
                        </div>
                ...
                <div className={`sidePanel w-full h-full flex flex-col gap-2 bg-slate-50 absolute transition-all ${isSidePanelOpen ? 'translate-x-0' : '-translate-x-full'} top-0`}>
                    <header
                        className='flex justify-between items-center px-4 p-2 bg-slate-200'>
                        <h1
